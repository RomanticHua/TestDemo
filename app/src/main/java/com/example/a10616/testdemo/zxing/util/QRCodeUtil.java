package com.example.a10616.testdemo.zxing.util;
...
//            SPUtils.putString("share_code_filePath",filePath);
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    boolean success = QRCodeUtil.createQRImage(text,dp2px(mContext,400) , dp2px(mContext,400), BitmapFactory.decodeResource(mContext.getResources(), centerPhoto),
                            filePath);
