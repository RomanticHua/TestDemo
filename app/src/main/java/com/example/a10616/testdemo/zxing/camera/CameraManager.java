...
public final class CameraManager {
     ...
     *
     * @param context The Activity which wants to use the activity_scan_code.
     */
...
//         Build.VERSION_CODES.CUPCAKE;
    ...
    /**
     * Opens the activity_scan_code driver and initializes the hardware parameters.
     *
     * @param holder The surface object which the activity_scan_code will draw preview frames
     *               into.
     * @throws IOException Indicates the activity_scan_code driver failed to open.
     */
    ...
    /**
     * Closes the activity_scan_code driver if still in use.
     */
    ...
    /**
     * Asks the activity_scan_code hardware to begin drawing preview frames to the screen.
     */
    ...
    /**
     * Tells the activity_scan_code to stop drawing preview frames.
     */
    ...
    /**
     * Asks the activity_scan_code hardware to perform an autofocus.
     *
        ...
        if (framingRect == null) {
	      ...
	      if (height < MIN_FRAME_HEIGHT) {
            ...
            if (screenResolution.x > screenResolution.y) {
                width = screenResolution.y * 3 / 5 - offset;
                height = width;
            } else {
                width = screenResolution.x * 3 / 5 - offset;
                height = width;
            }
            int leftOffset = (screenResolution.x - width) / 2;
            int topOffset = (screenResolution.y - height - dp2px(context, 150)) / 2;
