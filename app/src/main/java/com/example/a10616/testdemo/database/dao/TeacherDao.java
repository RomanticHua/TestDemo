...
public class TeacherDao extends AbstractDao<Teacher, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Flow = new Property(1, String.class, "flow", false, "FLOW");
    ...
    public Teacher readEntity(Cursor cursor, int offset) {
        Teacher entity = new Teacher( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // flow
            cursor.isNull(offset + 2) ? null : typeConverter.convertToEntityProperty(cursor.getString(offset + 2)) // type
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Teacher entity, int offset) {
        ...
        entity.setFlow(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setType(cursor.isNull(offset + 2) ? null : typeConverter.convertToEntityProperty(cursor.getString(offset + 2)));
     }
